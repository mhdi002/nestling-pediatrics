...
DOMAIN_PATTERNS = [
    (re.compile(r"حيطه\s*برقراري\s*ارتباط"), "برقراری ارتباط", "communication"),
    (re.compile(r"حيطه\s*حركات\s*درشت"), "حرکات درشت", "gross_motor"),
    (re.compile(r"حيطه\s*حركات\s*ظريف"), "حرکات ظریف", "fine_motor"),
    (re.compile(r"حيطه\s*حل\s*مسئله"), "حل مسئله", "problem_solving"),
    (re.compile(r"حيطه\s*شخصي\s*[-\u2013]?\s*اجتماعي"), "شخصی-اجتماعی", "personal_social"),
    (re.compile(r"موارد\s*كلي"), "موارد کلی", "overall"),
]
